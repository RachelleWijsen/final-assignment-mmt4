...
plyr.each(function(i){
    ...
    players.on('timeupdate',function(){
       ...
       if(times>=duration){
        ...
        playerPop.append('<div class= "pop-up">  <div class= "ok-button" ></div><div class="clear"></div><div class="ani"></div> <p class=tekst-pop-up> proud of you, you survived the epic video! </p> </div>')
